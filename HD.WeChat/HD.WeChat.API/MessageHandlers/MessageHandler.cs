...
namespace HD.WeChat.API.MessageHandlers
{
    ...
    public abstract class MessageHandler<TC> : IMessageHandler where TC : class, IMessageContext, new()
    {
        ...
        /// 上下文
        /// </summary>
        public static WXContext<TC> GlobalWeixinContext = new WXContext<TC>();

        /// <summary>
        /// 全局消息上下文
        /// </summary>
        public WXContext<TC> WeixinContext
        {
        ...
        private void Init(XDocument requestDocument)
        {
            ...
            //记录上下文
            if (WXContextGlobal.UseWeixinContext)
            {
            ...
            try
            {
                ...
                switch (RequestMessage.MsgType)
                {
                    ...
                    case RequestMsgType.Event:
                        {
                            var requestMessageText = (RequestMessage as IRequestMessageEventBase).ToRequestMessageText();
                ...
                //记录上下文
                if (WXContextGlobal.UseWeixinContext && ResponseMessage != null)
                {
