...
namespace HD.WeChat.API.Context
{
    public interface IMessageContext
    {
        ...
        event EventHandler<WXContextRemovedEventArgs> MessageContextRemoved;
    ...
    public class MessageContext : IMessageContext
    {
        ...
        public event EventHandler<WXContextRemovedEventArgs> MessageContextRemoved = null;
        ...
        /// </summary>
        /// <param name="e"></param>
        private void OnMessageContextRemoved(WXContextRemovedEventArgs e)
        {
            EventHandler<WXContextRemovedEventArgs> temp = MessageContextRemoved;
        ...
        {
            var onRemovedArg = new WXContextRemovedEventArgs(this);
